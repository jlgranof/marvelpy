"""Series endpoint for Marvel API.

This module provides the SeriesEndpoint class for interacting with
Marvel API series resources. It provides type-safe methods for
retrieving series data and related information.
"""
...
class SeriesEndpoint(BaseEndpoint):
    """Endpoint for Marvel API series resources.

    This class provides methods for retrieving series data from the
    Marvel API, including individual series, series lists, and
    related resources like characters, comics, creators, events, and stories.
    ...
    Example:
        ...
        ... )
        >>> series = await endpoint.get_series(1991)  # Get Avengers (1998-2004)
        >>> series_list = await endpoint.list_series(limit=10)  # Get first 10 series
    """
    ...
    async def get_comics(
        ...
        """Get comics that are part of a specific series.
    ...
    async def get_events(
        ...
        """Get events related to a specific series.
    ...
    async def get_stories(
        ...
        """Get stories that are part of a specific series.
