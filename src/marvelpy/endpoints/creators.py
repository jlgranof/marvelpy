"""Creators endpoint for Marvel API.

This module provides the CreatorsEndpoint class for interacting with
Marvel API creator resources. It provides type-safe methods for
retrieving creator data and related information.
"""
...
class CreatorsEndpoint(BaseEndpoint):
    """Endpoint for Marvel API creator resources.

    This class provides methods for retrieving creator data from the
    Marvel API, including individual creators, creator lists, and
    related resources like characters, comics, events, series, and stories.
    ...
    Example:
        ...
        ... )
        >>> creator = await endpoint.get_creator(30)  # Get Stan Lee
        >>> creators = await endpoint.list_creators(limit=10)  # Get first 10 creators
    """
    ...
    async def list_creators(
        ...
        """Get a list of creators with optional filtering.
    ...
    async def get_characters(
        ...
        """Get characters that a specific creator has worked on.
    ...
    async def get_comics(
        ...
        """Get comics that a specific creator has worked on.
    ...
    async def get_events(
        ...
        """Get events that a specific creator has worked on.
    ...
    async def get_series(
        ...
        """Get series that a specific creator has worked on.
    ...
    async def get_stories(
        ...
        """Get stories that a specific creator has worked on.
